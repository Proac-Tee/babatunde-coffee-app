...
## Auth Header
# get_token_auth_header import
from ..database.settings import AUTH0_DOMAIN, ALGORITHMS, API_AUDIENCE
...
# get_token_auth_header implementation
